document.addEventListener('DOMContentLoaded', () => {
    ...
    if (submitTrigger && submitDialog && closeSubmit && submitForm) {
        ...
        // Form Profession Button Toggle Logic
        // We need to attach listeners after they are in the DOM. 
        // Since they are static now (generated by build.js), we can attach here.
        const formBtns = document.querySelectorAll('.profession-tag.form-btn');
        ...
        submitForm.addEventListener('submit', (e) => {
            ...
            const professions = Array.from(document.querySelectorAll('.profession-tag.form-btn.selected'))
                .map(btn => btn.dataset.profession);
